  ...
  return (
    <div className="my-32 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
      <h1 className="mt-2 text-[32px] text-[#292A35] font-semibold text-center">
        Add Information About The Adoptable Pet
      </h1>
      ...
      <div className="border lg:mx-80 my-12 rounded">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="px-8 py-6 space-y-4">
          ...
          <div className="flex flex-col space-y-1">
            <label>
              Location <span className="text-xl text-[#F29500] py-4">*</span>
            </label>
            <select
            ...
            >
              ...
              {errors.address && (
                <span className="text-[red] py-1">Location is required</span>
              )}
            </select>
          </div>
          ...
          <div>
            <button
              ...
              className="px-6 py-4 bg-[#272633] text-white hover:bg-[#FC7676] duration-300 cursor-pointer rounded flex justify-center items-center gap-2"
              type="submit"
            >
              {postLoading ? (
